  ...
  return (
    <div className="pt-20">
      <section className="py-12 md:py-16 bg-[#0F0F0F] text-white text-center">
        <p className="text-[#F5C518] text-sm font-semibold uppercase tracking-[0.2em] mb-3">Prenotazione online</p>
        ...
        <div className="mt-5 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-sm text-white/80">
          <span className="text-[#F5C518]">📍</span>
          <span>WASH HUB Lungomare — Via Anfuso 35, Catania</span>
        </div>
      </section>
