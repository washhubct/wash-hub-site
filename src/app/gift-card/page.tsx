...
const GIFT_CARDS = [
  {
    value: '20',
    label: '1–2 lavaggi',
    desc: 'Perfetta per un regalo veloce. Copre 1 lavaggio completo o 2 lavaggi esterni.',
  ...
  },
  {
    value: '50',
    label: '3–4 lavaggi',
    desc: 'Il regalo più apprezzato. Vale per 3-4 lavaggi — l\'auto sempre impeccabile per mesi.',
  ...
  {
    value: '100',
    label: 'Fino a 7 lavaggi',
    desc: 'Il massimo. Include anche un lavaggio Performance Intenso o tappezzeria base.',
    color: 'bg-white border-[#E8E8E4]',
    highlight: false,
